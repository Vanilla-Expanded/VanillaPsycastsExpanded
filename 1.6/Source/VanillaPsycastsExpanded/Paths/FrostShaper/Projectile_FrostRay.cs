...
public class Projectile_FrostRay : Projectile
{
    ...
    protected override void DrawAt(Vector3 drawLoc, bool flip = false)
    {
        ...
        Comps_PostDraw();
        UnityEngine.Graphics.DrawMesh(MeshPool.GridPlane(new(5f, distanceSize)), position, ExactRotation, (Graphic as Graphic_Animated).MatSingle, 0);
    }
    ...
    protected override void Tick()
    {
        ...
        if (this.IsHashIntervalTick(10))
        {
            ...
            foreach (var victim in pawns)
            {
                ...
                if (victim.CanReceiveHypothermia(out var hediff)) HealthUtility.AdjustSeverity(victim, hediff, 0.08f / 6f);
